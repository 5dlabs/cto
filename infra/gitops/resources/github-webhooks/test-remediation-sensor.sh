...
echo "   kubectl get workflows -n agent-platform -l type=remediation-workflow"
echo ""
echo "3. Check for created CodeRun:"
echo "   kubectl get coderuns -n agent-platform -l trigger-type=comment-feedback"
echo ""
echo "4. Verify CodeRun spec contains REMEDIATION_MODE=true:"
echo "   kubectl get coderun <coderun-name> -n agent-platform -o yaml | grep -A5 'env:'"
