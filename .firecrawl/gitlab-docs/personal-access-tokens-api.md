...
## List all personal access tokens [Permalink](https://docs.gitlab.com/api/personal_access_tokens/\#list-all-personal-access-tokens "Permalink")
...
## Retrieve a personal access token [Permalink](https://docs.gitlab.com/api/personal_access_tokens/\#retrieve-a-personal-access-token "Permalink")
...
### Self-inform [Permalink](https://docs.gitlab.com/api/personal_access_tokens/\#self-inform "Permalink")
...
## Create a personal access token [Permalink](https://docs.gitlab.com/api/personal_access_tokens/\#create-a-personal-access-token "Permalink")
...
## Rotate a personal access token [Permalink](https://docs.gitlab.com/api/personal_access_tokens/\#rotate-a-personal-access-token "Permalink")
...
### Self-rotate [Permalink](https://docs.gitlab.com/api/personal_access_tokens/\#self-rotate "Permalink")
...
### Automatic reuse detection [Permalink](https://docs.gitlab.com/api/personal_access_tokens/\#automatic-reuse-detection "Permalink")
...
## Revoke a personal access token [Permalink](https://docs.gitlab.com/api/personal_access_tokens/\#revoke-a-personal-access-token "Permalink")
...
### Self-revoke [Permalink](https://docs.gitlab.com/api/personal_access_tokens/\#self-revoke "Permalink")
...
## List all token associations [Permalink](https://docs.gitlab.com/api/personal_access_tokens/\#list-all-token-associations "Permalink")
...
## Related topics [Permalink](https://docs.gitlab.com/api/personal_access_tokens/\#related-topics "Permalink")
