...
## Retrieve a group [Permalink](https://docs.gitlab.com/api/groups/\#retrieve-a-group "Permalink")
...
To get the details of all projects within a group, use either the [list a group’s projects](https://docs.gitlab.com/api/groups/#list-projects) or the [list a group’s shared projects](https://docs.gitlab.com/api/groups/#list-shared-projects) endpoint.
...
## List groups [Permalink](https://docs.gitlab.com/api/groups/\#list-groups "Permalink")

### List all groups [Permalink](https://docs.gitlab.com/api/groups/\#list-all-groups "Permalink")
...
#### Group pagination [Permalink](https://docs.gitlab.com/api/groups/\#group-pagination "Permalink")
...
### Search for a group [Permalink](https://docs.gitlab.com/api/groups/\#search-for-a-group "Permalink")
...
## List group details [Permalink](https://docs.gitlab.com/api/groups/\#list-group-details "Permalink")

### List projects [Permalink](https://docs.gitlab.com/api/groups/\#list-projects "Permalink")
...
### List shared projects [Permalink](https://docs.gitlab.com/api/groups/\#list-shared-projects "Permalink")
...
### List all SAML users [Permalink](https://docs.gitlab.com/api/groups/\#list-all-saml-users "Permalink")
...
### List provisioned users [Permalink](https://docs.gitlab.com/api/groups/\#list-provisioned-users "Permalink")
...
### List subgroups [Permalink](https://docs.gitlab.com/api/groups/\#list-subgroups "Permalink")
...
### List descendant groups [Permalink](https://docs.gitlab.com/api/groups/\#list-descendant-groups "Permalink")
...
### List shared groups [Permalink](https://docs.gitlab.com/api/groups/\#list-shared-groups "Permalink")
...
### List invited groups [Permalink](https://docs.gitlab.com/api/groups/\#list-invited-groups "Permalink")
...
### List audit events [Permalink](https://docs.gitlab.com/api/groups/\#list-audit-events "Permalink")
...
## Manage groups [Permalink](https://docs.gitlab.com/api/groups/\#manage-groups "Permalink")

### Create a group [Permalink](https://docs.gitlab.com/api/groups/\#create-a-group "Permalink")
...
#### Options for `default_branch_protection` [Permalink](https://docs.gitlab.com/api/groups/\#options-for-default_branch_protection "Permalink")
...
#### Options for `default_branch_protection_defaults` [Permalink](https://docs.gitlab.com/api/groups/\#options-for-default_branch_protection_defaults "Permalink")
...
### Create a subgroup [Permalink](https://docs.gitlab.com/api/groups/\#create-a-subgroup "Permalink")
...
### Schedule a group for deletion [Permalink](https://docs.gitlab.com/api/groups/\#schedule-a-group-for-deletion "Permalink")
...
#### Delete a group permanently [Permalink](https://docs.gitlab.com/api/groups/\#delete-a-group-permanently "Permalink")
...
#### Restore a group marked for deletion [Permalink](https://docs.gitlab.com/api/groups/\#restore-a-group-marked-for-deletion "Permalink")
...
### Archive a group [Permalink](https://docs.gitlab.com/api/groups/\#archive-a-group "Permalink")

History

- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/481969) in GitLab 18.0 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `archive_group`. Disabled by default.
...
#### Unarchive a group [Permalink](https://docs.gitlab.com/api/groups/\#unarchive-a-group "Permalink")
...
### Transfer a group [Permalink](https://docs.gitlab.com/api/groups/\#transfer-a-group "Permalink")
...
#### List all locations available for group transfer [Permalink](https://docs.gitlab.com/api/groups/\#list-all-locations-available-for-group-transfer "Permalink")
...
#### Transfer a project to a group [Permalink](https://docs.gitlab.com/api/groups/\#transfer-a-project-to-a-group "Permalink")
...
### Invite groups [Permalink](https://docs.gitlab.com/api/groups/\#invite-groups "Permalink")
...
#### Create a group invitation [Permalink](https://docs.gitlab.com/api/groups/\#create-a-group-invitation "Permalink")
...
#### Delete a group invitation [Permalink](https://docs.gitlab.com/api/groups/\#delete-a-group-invitation "Permalink")
...
## Update group attributes [Permalink](https://docs.gitlab.com/api/groups/\#update-group-attributes "Permalink")
...
[list a group’s projects endpoint](https://docs.gitlab.com/api/groups/#list-projects) instead.
...
### Options for `shared_runners_setting` [Permalink](https://docs.gitlab.com/api/groups/\#options-for-shared_runners_setting "Permalink")
...
## Update group avatars [Permalink](https://docs.gitlab.com/api/groups/\#update-group-avatars "Permalink")

Update group avatars.

### Download a group avatar [Permalink](https://docs.gitlab.com/api/groups/\#download-a-group-avatar "Permalink")
...
### Upload a group avatar [Permalink](https://docs.gitlab.com/api/groups/\#upload-a-group-avatar "Permalink")
...
### Remove a group avatar [Permalink](https://docs.gitlab.com/api/groups/\#remove-a-group-avatar "Permalink")
...
## Sync a group with LDAP [Permalink](https://docs.gitlab.com/api/groups/\#sync-a-group-with-ldap "Permalink")
...
## Credentials inventory management [Permalink](https://docs.gitlab.com/api/groups/\#credentials-inventory-management "Permalink")
...
### List all personal access tokens for a group [Permalink](https://docs.gitlab.com/api/groups/\#list-all-personal-access-tokens-for-a-group "Permalink")
...
### List all group and project access tokens for a group [Permalink](https://docs.gitlab.com/api/groups/\#list-all-group-and-project-access-tokens-for-a-group "Permalink")
...
### List all SSH keys for a group [Permalink](https://docs.gitlab.com/api/groups/\#list-all-ssh-keys-for-a-group "Permalink")
...
### Revoke a personal access token for an enterprise user [Permalink](https://docs.gitlab.com/api/groups/\#revoke-a-personal-access-token-for-an-enterprise-user "Permalink")
...
### Revoke a group or project access token for an enterprise user [Permalink](https://docs.gitlab.com/api/groups/\#revoke-a-group-or-project-access-token-for-an-enterprise-user "Permalink")
...
### Delete an SSH key for an enterprise user [Permalink](https://docs.gitlab.com/api/groups/\#delete-an-ssh-key-for-an-enterprise-user "Permalink")
...
### Rotate a personal access token for an enterprise user [Permalink](https://docs.gitlab.com/api/groups/\#rotate-a-personal-access-token-for-an-enterprise-user "Permalink")
...
### Rotate a group or project access token for an enterprise user [Permalink](https://docs.gitlab.com/api/groups/\#rotate-a-group-or-project-access-token-for-an-enterprise-user "Permalink")
