...
This page lists the events that are triggered for [project webhooks](https://docs.gitlab.com/user/project/integrations/webhooks/) and [group webhooks](https://docs.gitlab.com/user/project/integrations/webhooks/#group-webhooks).

For a list of events triggered for system webhooks, see [system webhooks](https://docs.gitlab.com/administration/system_hooks/).

## Events triggered for both project and group webhooks [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#events-triggered-for-both-project-and-group-webhooks "Permalink")

| Event type | Trigger |
| --- | --- |
| [Comment event](https://docs.gitlab.com/user/project/integrations/webhook_events/#comment-events) | A new comment is made or edited on commits, merge requests, issues, and code snippets. 1 |
| [Deployment event](https://docs.gitlab.com/user/project/integrations/webhook_events/#deployment-events) | A deployment starts, succeeds, fails, or is canceled. |
| [Emoji event](https://docs.gitlab.com/user/project/integrations/webhook_events/#emoji-events) | An emoji reaction is added or removed. |
| [Feature flag event](https://docs.gitlab.com/user/project/integrations/webhook_events/#feature-flag-events) | A feature flag is turned on or off. |
| [Job event](https://docs.gitlab.com/user/project/integrations/webhook_events/#job-events) | A job status changes. |
| [Merge request event](https://docs.gitlab.com/user/project/integrations/webhook_events/#merge-request-events) | A merge request is created, edited, merged, or closed, or a commit is added in the source branch. |
| [Milestone event](https://docs.gitlab.com/user/project/integrations/webhook_events/#milestone-events) | A milestone is created, closed, reopened, or deleted. |
| [Pipeline event](https://docs.gitlab.com/user/project/integrations/webhook_events/#pipeline-events) | A pipeline status changes. |
| [Project or group access token event](https://docs.gitlab.com/user/project/integrations/webhook_events/#project-and-group-access-token-events) | A project or group access token will expire in seven days. |
| [Push event](https://docs.gitlab.com/user/project/integrations/webhook_events/#push-events) | A push is made to the repository. |
| [Release event](https://docs.gitlab.com/user/project/integrations/webhook_events/#release-events) | A release is created, edited, or deleted. |
| [Tag event](https://docs.gitlab.com/user/project/integrations/webhook_events/#tag-events) | Tags are created or deleted in the repository. |
| [Vulnerability event](https://docs.gitlab.com/user/project/integrations/webhook_events/#vulnerability-events) | A vulnerability is created or updated. |
| [Wiki page event](https://docs.gitlab.com/user/project/integrations/webhook_events/#wiki-page-events) | A wiki page is created, edited, or deleted. |
| [Work item event](https://docs.gitlab.com/user/project/integrations/webhook_events/#work-item-events) | A new work item is created or an existing one is edited, closed, or reopened. |
...
## Events triggered for group webhooks only [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#events-triggered-for-group-webhooks-only "Permalink")

| Event type | Trigger |
| --- | --- |
| [Group member event](https://docs.gitlab.com/user/project/integrations/webhook_events/#group-member-events) | A user is added or removed from a group, or a user’s access level or access expiration date changes. |
| [Project event](https://docs.gitlab.com/user/project/integrations/webhook_events/#project-events) | A project is created or deleted in a group. |
| [Subgroup event](https://docs.gitlab.com/user/project/integrations/webhook_events/#subgroup-events) | A subgroup is created or removed from a group. |
...
## Push events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#push-events "Permalink")
...
(depending on the [`push_event_hooks_limit` setting](https://docs.gitlab.com/api/settings/#available-settings)).
...
[Push event activities limit](https://docs.gitlab.com/administration/settings/push_event_activities_limit/).
...
## Tag events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#tag-events "Permalink")
...
[application Settings API](https://docs.gitlab.com/api/settings/#available-settings).
...
## Work item events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#work-item-events "Permalink")

History

- `type` attribute in `object_attributes` [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/467415) in GitLab 17.2.
- Support for epics [introduced](https://gitlab.com/groups/gitlab-org/-/epics/13056) in GitLab 17.3. [The new look for epics](https://docs.gitlab.com/user/group/epics/#epics-as-work-items) must be enabled.
...
- [Objectives and key results (OKRs)](https://docs.gitlab.com/user/okrs/)

For issues and [Service Desk](https://docs.gitlab.com/user/project/service_desk/) issues, the `object_kind` is `issue`, and the `type` is `Issue`.
...
only available for issue types which [support escalations](https://docs.gitlab.com/operations/incident_management/paging/#paging),
such as incidents.
...
## Comment events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#comment-events "Permalink")
...
### Comment on a commit [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#comment-on-a-commit "Permalink")
...
### Comment on a merge request [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#comment-on-a-merge-request "Permalink")
...
### Comment on an issue [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#comment-on-an-issue "Permalink")
...
### Comment on a code snippet [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#comment-on-a-code-snippet "Permalink")
...
## Merge request events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#merge-request-events "Permalink")
...
### Payload structure [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#payload-structure "Permalink")
...
### Deprecated fields [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#deprecated-fields "Permalink")
...
### `object_attributes` field [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#object_attributes-field "Permalink")
...
| `detailed_merge_status` | String | Detailed merge status information. For a list of potential values, see [merge status](https://docs.gitlab.com/api/merge_requests/#merge-status). |
...
| `prepared_at` | String | Timestamp of when the merge request was prepared. This field populates one time, only after all the [preparation steps](https://docs.gitlab.com/api/merge_requests/#preparation-steps) complete, and is not updated if more changes are added. |
...
### `changes` field [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#changes-field "Permalink")
...
#### Attributes [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#attributes "Permalink")
...
### Merge request action-specific fields [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#merge-request-action-specific-fields "Permalink")
...
- A [suggestion](https://docs.gitlab.com/user/project/merge_requests/reviews/suggestions/) is applied.
...
### System-initiated merge request events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#system-initiated-merge-request-events "Permalink")
...
### Reviewer state tracking [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#reviewer-state-tracking "Permalink")
...
### Re-request review events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#re-request-review-events "Permalink")
...
### Complete payload example [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#complete-payload-example "Permalink")
...
recommended alternatives, see [deprecated fields](https://docs.gitlab.com/user/project/integrations/webhook_events/#deprecated-fields).
...
The fields `assignee_id` and `merge_status` are [deprecated](https://docs.gitlab.com/api/merge_requests/).

## Wiki page events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#wiki-page-events "Permalink")
...
## Pipeline events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#pipeline-events "Permalink")
...
## Job events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#job-events "Permalink")
...
### Number of retries [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#number-of-retries "Permalink")

History

- `retries_count` [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/382046) in GitLab 15.6 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `job_webhook_retries_count`. Disabled by default.
...
### Pipeline name [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#pipeline-name "Permalink")

History

- `commit.name` [introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/107963) in GitLab 15.8.

You can set custom names for pipelines with [`workflow:name`](https://docs.gitlab.com/ci/yaml/#workflowname).
If the pipeline has a name, that name is the value of `commit.name`.

## Deployment events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#deployment-events "Permalink")
...
When the deployment event occurs by [API](https://docs.gitlab.com/ci/environments/external_deployment_tools/) or [`trigger` jobs](https://docs.gitlab.com/ci/pipelines/downstream_pipelines/), `deployable_url` is `null`.
...
## Group member events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#group-member-events "Permalink")
...
These events are triggered for [group webhooks](https://docs.gitlab.com/user/project/integrations/webhooks/#group-webhooks) only.
...
### Add member to group [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#add-member-to-group "Permalink")
...
### Update member access level or expiration date [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#update-member-access-level-or-expiration-date "Permalink")
...
### Remove member from group [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#remove-member-from-group "Permalink")
...
### A user requests access [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#a-user-requests-access "Permalink")

History

- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/163094) in GitLab 17.4 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `group_access_request_webhooks`. Disabled by default.
...
### An access request is denied [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#an-access-request-is-denied "Permalink")
...
## Project events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#project-events "Permalink")
...
- A [project is created in a group](https://docs.gitlab.com/user/project/integrations/webhook_events/#create-a-project-in-a-group).
- A [project is deleted in a group](https://docs.gitlab.com/user/project/integrations/webhook_events/#delete-a-project-in-a-group).

### Create a project in a group [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#create-a-project-in-a-group "Permalink")
...
### Delete a project in a group [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#delete-a-project-in-a-group "Permalink")
...
## Subgroup events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#subgroup-events "Permalink")
...
- A [subgroup is created in a group](https://docs.gitlab.com/user/project/integrations/webhook_events/#create-a-subgroup-in-a-group).
- A [subgroup is removed from a group](https://docs.gitlab.com/user/project/integrations/webhook_events/#remove-a-subgroup-from-a-group).

### Create a subgroup in a group [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#create-a-subgroup-in-a-group "Permalink")
...
### Remove a subgroup from a group [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#remove-a-subgroup-from-a-group "Permalink")

This webhook is not triggered when a [subgroup is transferred to a new parent group](https://docs.gitlab.com/user/group/manage/#transfer-a-group).
...
## Feature flag events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#feature-flag-events "Permalink")
...
## Release events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#release-events "Permalink")
...
## Milestone events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#milestone-events "Permalink")
...
## Emoji events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#emoji-events "Permalink")

History

- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/123952) in GitLab 16.2 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `emoji_webhooks`. Disabled by default.
...
An emoji event is triggered when an [emoji reaction](https://docs.gitlab.com/user/emoji_reactions/) is added or removed on:
...
## Project and group access token events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#project-and-group-access-token-events "Permalink")

History

- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/141907) in GitLab 16.10 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `access_token_webhooks`. Disabled by default.
...
Access token expiry events trigger before an [access tokens](https://docs.gitlab.com/security/tokens/) expires.
...
- [Add additional webhook triggers for project access token expiration](https://docs.gitlab.com/user/project/settings/#add-additional-webhook-triggers-for-project-access-token-expiration).
- [Add additional webhook triggers for group access token expiration](https://docs.gitlab.com/user/group/manage/#add-additional-webhook-triggers-for-group-access-token-expiration).
...
## Project and group deploy token events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#project-and-group-deploy-token-events "Permalink")

History

- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/196804) in GitLab 18.4 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `project_deploy_token_expiring_notifications`. Disabled by default.

Deploy token expiry events trigger before a [deploy token](https://docs.gitlab.com/security/tokens/) expires.
These events trigger:
...
## Vulnerability events [Permalink](https://docs.gitlab.com/user/project/integrations/webhook_events/\#vulnerability-events "Permalink")

History

- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/169701) in GitLab 17.7 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `vulnerabilities_as_webhook_events`. Disabled by default.
...
- A vulnerability’s [status is changed](https://docs.gitlab.com/user/application_security/vulnerabilities/#vulnerability-status-values).
