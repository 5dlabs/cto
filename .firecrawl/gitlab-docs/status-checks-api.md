...
## Retrieve project external status check services [Permalink](https://docs.gitlab.com/api/status_checks/\#retrieve-project-external-status-check-services "Permalink")
...
## Create external status check service [Permalink](https://docs.gitlab.com/api/status_checks/\#create-external-status-check-service "Permalink")
...
## Update external status check service [Permalink](https://docs.gitlab.com/api/status_checks/\#update-external-status-check-service "Permalink")
...
## Delete external status check service [Permalink](https://docs.gitlab.com/api/status_checks/\#delete-external-status-check-service "Permalink")
...
## List all status checks for a merge request [Permalink](https://docs.gitlab.com/api/status_checks/\#list-all-status-checks-for-a-merge-request "Permalink")
...
## Set status of an external status check [Permalink](https://docs.gitlab.com/api/status_checks/\#set-status-of-an-external-status-check "Permalink")
...
## Retry failed status check for a merge request [Permalink](https://docs.gitlab.com/api/status_checks/\#retry-failed-status-check-for-a-merge-request "Permalink")
...
## Response [Permalink](https://docs.gitlab.com/api/status_checks/\#response "Permalink")
...
## Example payload sent to external service [Permalink](https://docs.gitlab.com/api/status_checks/\#example-payload-sent-to-external-service "Permalink")
...
## Related topics [Permalink](https://docs.gitlab.com/api/status_checks/\#related-topics "Permalink")
