...
## List all issues [Permalink](https://docs.gitlab.com/api/issues/\#list-all-issues "Permalink")
...
## List all group issues [Permalink](https://docs.gitlab.com/api/issues/\#list-all-group-issues "Permalink")
...
## List all project issues [Permalink](https://docs.gitlab.com/api/issues/\#list-all-project-issues "Permalink")
...
This endpoint supports both offset-based and [keyset-based](https://docs.gitlab.com/api/rest/#keyset-based-pagination) pagination. You should use keyset-based
...
## Retrieve an issue [Permalink](https://docs.gitlab.com/api/issues/\#retrieve-an-issue "Permalink")
...
## Retrieve a project issue [Permalink](https://docs.gitlab.com/api/issues/\#retrieve-a-project-issue "Permalink")
...
## Create an issue [Permalink](https://docs.gitlab.com/api/issues/\#create-an-issue "Permalink")
...
If the target project has **Issues** [turned off](https://docs.gitlab.com/user/project/settings/#toggle-project-features),
...
### Rate limits [Permalink](https://docs.gitlab.com/api/issues/\#rate-limits "Permalink")

To help avoid abuse, users can be limited to a specific number of `Create` requests per minute.
For more information, see [rate limits on issue and epic creation](https://docs.gitlab.com/administration/settings/rate_limit_on_issues_creation/).

## Update an issue [Permalink](https://docs.gitlab.com/api/issues/\#update-an-issue "Permalink")
...
## Delete an issue [Permalink](https://docs.gitlab.com/api/issues/\#delete-an-issue "Permalink")
...
## Reorder an issue [Permalink](https://docs.gitlab.com/api/issues/\#reorder-an-issue "Permalink")
...
## Move an issue [Permalink](https://docs.gitlab.com/api/issues/\#move-an-issue "Permalink")
...
## Clone an issue [Permalink](https://docs.gitlab.com/api/issues/\#clone-an-issue "Permalink")
...
## Notifications [Permalink](https://docs.gitlab.com/api/issues/\#notifications "Permalink")

The following requests are related to [email notifications](https://docs.gitlab.com/user/profile/notifications/) for issues.

### Subscribe to an issue [Permalink](https://docs.gitlab.com/api/issues/\#subscribe-to-an-issue "Permalink")
...
### Unsubscribe from an issue [Permalink](https://docs.gitlab.com/api/issues/\#unsubscribe-from-an-issue "Permalink")
...
## Create a to-do item for an issue [Permalink](https://docs.gitlab.com/api/issues/\#create-a-to-do-item-for-an-issue "Permalink")
...
## Promote an issue to an epic [Permalink](https://docs.gitlab.com/api/issues/\#promote-an-issue-to-an-epic "Permalink")

- Tier: Premium, Ultimate
- Offering: GitLab.com, GitLab Self-Managed, GitLab Dedicated

Promotes a specified issue to an epic by adding a comment with the
[`/promote_to`](https://docs.gitlab.com/user/project/quick_actions/#promote_to) quick action.

For more information, see
[promote an issue to an epic](https://docs.gitlab.com/user/project/issues/managing_issues/#promote-an-issue-to-an-epic).
...
## Time tracking [Permalink](https://docs.gitlab.com/api/issues/\#time-tracking "Permalink")

The following requests are related to [time tracking](https://docs.gitlab.com/user/project/time_tracking/) on issues.

### Set a time estimate for an issue [Permalink](https://docs.gitlab.com/api/issues/\#set-a-time-estimate-for-an-issue "Permalink")
...
### Reset the time estimate for an issue [Permalink](https://docs.gitlab.com/api/issues/\#reset-the-time-estimate-for-an-issue "Permalink")
...
### Add spent time for an issue [Permalink](https://docs.gitlab.com/api/issues/\#add-spent-time-for-an-issue "Permalink")
...
### Reset spent time for an issue [Permalink](https://docs.gitlab.com/api/issues/\#reset-spent-time-for-an-issue "Permalink")
...
### Retrieve time tracking stats for an issue [Permalink](https://docs.gitlab.com/api/issues/\#retrieve-time-tracking-stats-for-an-issue "Permalink")
...
## Merge requests [Permalink](https://docs.gitlab.com/api/issues/\#merge-requests "Permalink")

The following requests are related to relationships between issues and merge requests.

### List all merge requests related to an issue [Permalink](https://docs.gitlab.com/api/issues/\#list-all-merge-requests-related-to-an-issue "Permalink")
...
### List all merge requests that close an issue on merge [Permalink](https://docs.gitlab.com/api/issues/\#list-all-merge-requests-that-close-an-issue-on-merge "Permalink")
...
## List all participants in an issue [Permalink](https://docs.gitlab.com/api/issues/\#list-all-participants-in-an-issue "Permalink")
...
## Comments on issues [Permalink](https://docs.gitlab.com/api/issues/\#comments-on-issues "Permalink")

Interact with comments using the [notes API](https://docs.gitlab.com/api/notes/).

## Retrieve user agent details for an issue [Permalink](https://docs.gitlab.com/api/issues/\#retrieve-user-agent-details-for-an-issue "Permalink")
...
## List issue state events [Permalink](https://docs.gitlab.com/api/issues/\#list-issue-state-events "Permalink")

To track which state was set, who did it, and when it happened, use the
[resource state events API](https://docs.gitlab.com/api/resource_state_events/#issues).

## Incidents [Permalink](https://docs.gitlab.com/api/issues/\#incidents "Permalink")

The following requests are available only for [incidents](https://docs.gitlab.com/operations/incident_management/incidents/).

### Upload a metric image for an incident [Permalink](https://docs.gitlab.com/api/issues/\#upload-a-metric-image-for-an-incident "Permalink")
...
### List all metric images for an incident [Permalink](https://docs.gitlab.com/api/issues/\#list-all-metric-images-for-an-incident "Permalink")
...
### Update a metric image for an incident [Permalink](https://docs.gitlab.com/api/issues/\#update-a-metric-image-for-an-incident "Permalink")
...
### Delete a metric image from an incident [Permalink](https://docs.gitlab.com/api/issues/\#delete-a-metric-image-from-an-incident "Permalink")
