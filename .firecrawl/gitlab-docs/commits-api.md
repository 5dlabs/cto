...
## Responses [Permalink](https://docs.gitlab.com/api/commits/\#responses "Permalink")
...
### Pagination response headers [Permalink](https://docs.gitlab.com/api/commits/\#pagination-response-headers "Permalink")
...
## List repository commits [Permalink](https://docs.gitlab.com/api/commits/\#list-repository-commits "Permalink")
...
## Create a commit [Permalink](https://docs.gitlab.com/api/commits/\#create-a-commit "Permalink")
...
## Retrieve a commit [Permalink](https://docs.gitlab.com/api/commits/\#retrieve-a-commit "Permalink")
...
## List all references a commit is pushed to [Permalink](https://docs.gitlab.com/api/commits/\#list-all-references-a-commit-is-pushed-to "Permalink")
...
## Get commit sequence [Permalink](https://docs.gitlab.com/api/commits/\#get-commit-sequence "Permalink")
...
## Cherry-pick a commit [Permalink](https://docs.gitlab.com/api/commits/\#cherry-pick-a-commit "Permalink")
...
When `dry_run` is enabled, the server attempts to apply the cherry-pick _but_
_not actually commit any resulting changes_. If the cherry-pick applies cleanly,
...
## Revert a commit [Permalink](https://docs.gitlab.com/api/commits/\#revert-a-commit "Permalink")
...
When `dry_run` is enabled, the server attempts to apply the revert _but not_
_actually commit any resulting changes_. If the revert applies cleanly, the API
...
## Retrieve commit diff [Permalink](https://docs.gitlab.com/api/commits/\#retrieve-commit-diff "Permalink")
...
This endpoint is subject to [diff limits](https://docs.gitlab.com/administration/diff_limits/). When a commit
...
[diff display limits](https://docs.gitlab.com/user/gitlab_com/#diff-display-limits).
...
## List all commit comments [Permalink](https://docs.gitlab.com/api/commits/\#list-all-commit-comments "Permalink")
...
## Post comment to commit [Permalink](https://docs.gitlab.com/api/commits/\#post-comment-to-commit "Permalink")
...
[create a merge request note](https://docs.gitlab.com/api/notes/#create-a-merge-request-note) in the notes API,
and [create a new thread in the merge request diff](https://docs.gitlab.com/api/discussions/#create-a-new-thread-in-the-merge-request-diff)
...
## List all commit discussions [Permalink](https://docs.gitlab.com/api/commits/\#list-all-commit-discussions "Permalink")
...
## Commit status [Permalink](https://docs.gitlab.com/api/commits/\#commit-status "Permalink")

The commit status API for use with GitLab.

### List commit statuses [Permalink](https://docs.gitlab.com/api/commits/\#list-commit-statuses "Permalink")
...
### Set commit pipeline status [Permalink](https://docs.gitlab.com/api/commits/\#set-commit-pipeline-status "Permalink")
...
Configure your pipeline to [avoid duplicates](https://docs.gitlab.com/ci/jobs/job_rules/#avoid-duplicate-pipelines).
...
## List merge requests associated with a commit [Permalink](https://docs.gitlab.com/api/commits/\#list-merge-requests-associated-with-a-commit "Permalink")
...
## Retrieve commit signature [Permalink](https://docs.gitlab.com/api/commits/\#retrieve-commit-signature "Permalink")

Retrieves the [signature from a commit](https://docs.gitlab.com/user/project/repository/signed_commits/),
