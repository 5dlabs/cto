...
## Webhook events [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#webhook-events "Permalink")
...
## Webhook limits [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#webhook-limits "Permalink")
...
### Push event limits [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#push-event-limits "Permalink")
...
## Group webhooks [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#group-webhooks "Permalink")
...
### Types of group webhook events [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#types-of-group-webhook-events "Permalink")
...
### Webhooks in both a project and a group [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#webhooks-in-both-a-project-and-a-group "Permalink")
...
## Configure webhooks [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#configure-webhooks "Permalink")
...
### Create a webhook [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#create-a-webhook "Permalink")
...
4. In **URL**, enter the URL of the webhook endpoint.
...
### Mask sensitive portions of webhook URLs [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#mask-sensitive-portions-of-webhook-urls "Permalink")
...
6. In **How it looks in the UI**, enter the value to display instead of the masked portion.
...
### Custom headers [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#custom-headers "Permalink")
...
### Custom webhook template [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#custom-webhook-template "Permalink")
...
#### Create a custom webhook template [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#create-a-custom-webhook-template "Permalink")
...
#### Example custom webhook template [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#example-custom-webhook-template "Permalink")
...
### Filter push events by branch [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#filter-push-events-by-branch "Permalink")
...
#### Use a wildcard pattern [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#use-a-wildcard-pattern "Permalink")
...
#### Use a regular expression [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#use-a-regular-expression "Permalink")
...
### Configure webhooks to support mutual TLS [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#configure-webhooks-to-support-mutual-tls "Permalink")
...
### Configure firewalls for webhook traffic [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#configure-firewalls-for-webhook-traffic "Permalink")
...
## Manage webhooks [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#manage-webhooks "Permalink")

Monitor and maintain your configured webhooks in GitLab.

### View webhook request history [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#view-webhook-request-history "Permalink")
...
![Webhook event log showing status codes and response times](https://docs.gitlab.com/user/project/integrations/img/webhook_logs_v14_4.png)

#### Inspect request and response details [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#inspect-request-and-response-details "Permalink")
...
### Test a webhook [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#test-a-webhook "Permalink")
...
## Webhook reference [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#webhook-reference "Permalink")
...
### Webhook receiver requirements [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#webhook-receiver-requirements "Permalink")
...
### Auto-disabled webhooks [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#auto-disabled-webhooks "Permalink")
...
![Webhook list showing disabled and temporarily disabled status badges.](https://docs.gitlab.com/user/project/integrations/img/failed_badges_v17_11.png)

#### Temporarily disabled webhooks [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#temporarily-disabled-webhooks "Permalink")
...
#### Permanently disabled webhooks [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#permanently-disabled-webhooks "Permalink")
...
#### Re-enable disabled webhooks [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#re-enable-disabled-webhooks "Permalink")
...
### Delivery headers [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#delivery-headers "Permalink")
...
### Image URL display in webhook body [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#image-url-display-in-webhook-body "Permalink")

GitLab rewrites relative image references to absolute URLs in webhook bodies.

#### Image URL rewriting example [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#image-url-rewriting-example "Permalink")
...
#### Exceptions to image URL rewriting [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#exceptions-to-image-url-rewriting "Permalink")
...
## Related topics [Permalink](https://docs.gitlab.com/user/project/integrations/webhooks/\#related-topics "Permalink")
