...
For more information, see [create a project](https://docs.gitlab.com/user/project/).
...
## Prerequisites [Permalink](https://docs.gitlab.com/api/projects/\#prerequisites "Permalink")
...
## Project visibility level [Permalink](https://docs.gitlab.com/api/projects/\#project-visibility-level "Permalink")
...
## Project feature visibility level [Permalink](https://docs.gitlab.com/api/projects/\#project-feature-visibility-level "Permalink")
...
## Deprecated attributes [Permalink](https://docs.gitlab.com/api/projects/\#deprecated-attributes "Permalink")
...
## Retrieve a project [Permalink](https://docs.gitlab.com/api/projects/\#retrieve-a-project "Permalink")
...
## List projects [Permalink](https://docs.gitlab.com/api/projects/\#list-projects "Permalink")

List projects and project attributes.

### List all projects [Permalink](https://docs.gitlab.com/api/projects/\#list-all-projects "Permalink")
...
`last_activity_at` is updated based on [project activity](https://docs.gitlab.com/user/project/working_with_projects/#view-project-activity)
and [project events](https://docs.gitlab.com/api/events/). To optimize database performance, this field updates at most once per hour.
...
### List all personal projects for a user [Permalink](https://docs.gitlab.com/api/projects/\#list-all-personal-projects-for-a-user "Permalink")
...
### List all projects contributions for a user [Permalink](https://docs.gitlab.com/api/projects/\#list-all-projects-contributions-for-a-user "Permalink")
...
[View projects you work with](https://docs.gitlab.com/user/project/working_with_projects/#view-projects-you-work-with).
...
## List attributes [Permalink](https://docs.gitlab.com/api/projects/\#list-attributes "Permalink")

List attributes of a project.

### List all members of a project [Permalink](https://docs.gitlab.com/api/projects/\#list-all-members-of-a-project "Permalink")
...
### List all ancestor groups [Permalink](https://docs.gitlab.com/api/projects/\#list-all-ancestor-groups "Permalink")
...
### List all groups available to invite to a project [Permalink](https://docs.gitlab.com/api/projects/\#list-all-groups-available-to-invite-to-a-project "Permalink")
...
### List all invited groups in a project [Permalink](https://docs.gitlab.com/api/projects/\#list-all-invited-groups-in-a-project "Permalink")
...
### Retrieve programming language usage information [Permalink](https://docs.gitlab.com/api/projects/\#retrieve-programming-language-usage-information "Permalink")
...
If successful, returns [`200 OK`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and
...
## Manage projects [Permalink](https://docs.gitlab.com/api/projects/\#manage-projects "Permalink")

Manage a project, including creation, deletion, and archival.

### Create a project [Permalink](https://docs.gitlab.com/api/projects/\#create-a-project "Permalink")
...
see [Project feature visibility level](https://docs.gitlab.com/api/projects/#project-feature-visibility-level).

### Create a project for a user [Permalink](https://docs.gitlab.com/api/projects/\#create-a-project-for-a-user "Permalink")
...
### Update a project [Permalink](https://docs.gitlab.com/api/projects/\#update-a-project "Permalink")
...
| `only_allow_merge_if_all_status_checks_passed` | boolean | No | Indicates that merges of merge requests should be blocked unless all status checks have passed. Defaults to false.<br>[Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/369859) in GitLab 15.5 with feature flag `only_allow_merge_if_all_status_checks_passed` disabled by default. The feature flag was enabled by default in GitLab 15.9. Ultimate only. |
| `approvals_before_merge` | integer | No | How many approvers should approve merge requests by default. [Deprecated](https://gitlab.com/gitlab-org/gitlab/-/issues/353097) in GitLab 16.0. To configure approval rules, see [Merge request approvals API](https://docs.gitlab.com/api/merge_request_approvals/). Premium and Ultimate only. |
| `auto_cancel_pending_pipelines` | string | No | Auto-cancel pending pipelines. This action toggles between an enabled state and a disabled state; it is not a boolean. |
| `auto_devops_deploy_strategy` | string | No | Auto Deploy strategy (`continuous`, `manual`, or `timed_incremental`). |
| `auto_devops_enabled` | boolean | No | Enable Auto DevOps for this project. |
...
### Import members [Permalink](https://docs.gitlab.com/api/projects/\#import-members "Permalink")
...
### Archive a project [Permalink](https://docs.gitlab.com/api/projects/\#archive-a-project "Permalink")
...
### Unarchive a project [Permalink](https://docs.gitlab.com/api/projects/\#unarchive-a-project "Permalink")
...
### Delete a project [Permalink](https://docs.gitlab.com/api/projects/\#delete-a-project "Permalink")
...
[instance settings](https://docs.gitlab.com/administration/settings/visibility_and_access_controls/#deletion-protection).
...
### Restore a project marked for deletion [Permalink](https://docs.gitlab.com/api/projects/\#restore-a-project-marked-for-deletion "Permalink")
...
### Transfer a project to a new namespace [Permalink](https://docs.gitlab.com/api/projects/\#transfer-a-project-to-a-new-namespace "Permalink")

Transfers a project to a new namespace.

For information on prerequisites for transferring a project, see
[Transfer a project to another namespace](https://docs.gitlab.com/user/project/working_with_projects/#transfer-a-project).
...
#### List groups available for project transfer [Permalink](https://docs.gitlab.com/api/projects/\#list-groups-available-for-project-transfer "Permalink")
...
### Upload a project avatar [Permalink](https://docs.gitlab.com/api/projects/\#upload-a-project-avatar "Permalink")
...
### Download a project avatar [Permalink](https://docs.gitlab.com/api/projects/\#download-a-project-avatar "Permalink")
...
### Remove a project avatar [Permalink](https://docs.gitlab.com/api/projects/\#remove-a-project-avatar "Permalink")
...
## Share projects [Permalink](https://docs.gitlab.com/api/projects/\#share-projects "Permalink")
...
### Share a project with a group [Permalink](https://docs.gitlab.com/api/projects/\#share-a-project-with-a-group "Permalink")
...
### Delete a shared project link in a group [Permalink](https://docs.gitlab.com/api/projects/\#delete-a-shared-project-link-in-a-group "Permalink")
...
## Start the housekeeping task for a project [Permalink](https://docs.gitlab.com/api/projects/\#start-the-housekeeping-task-for-a-project "Permalink")

Starts the [housekeeping task](https://docs.gitlab.com/administration/housekeeping/) for a project.
...
## Real-time security scan [Permalink](https://docs.gitlab.com/api/projects/\#real-time-security-scan "Permalink")
...
## Download snapshot of a Git repository [Permalink](https://docs.gitlab.com/api/projects/\#download-snapshot-of-a-git-repository "Permalink")

This endpoint may only be accessed by an administrative user.

Downloads a snapshot of the project (or wiki, if requested) Git repository. This
snapshot is always in uncompressed [tar](https://en.wikipedia.org/wiki/Tar_%28computing%29)
format.
...
## Retrieve the path to repository storage [Permalink](https://docs.gitlab.com/api/projects/\#retrieve-the-path-to-repository-storage "Permalink")

Retrieves the path to repository storage for the specified project. If you’re using Gitaly Cluster (Praefect), see [Praefect-generated replica paths](https://docs.gitlab.com/administration/gitaly/praefect/#praefect-generated-replica-paths) instead.
...
## Secret push protection status [Permalink](https://docs.gitlab.com/api/projects/\#secret-push-protection-status "Permalink")
...
To modify the `secret_push_protection_enabled` value, use the [Project Security Settings API](https://docs.gitlab.com/api/project_security_settings/).
...
## Troubleshooting [Permalink](https://docs.gitlab.com/api/projects/\#troubleshooting "Permalink")

### Unexpected `restrict_user_defined_variables` value in response [Permalink](https://docs.gitlab.com/api/projects/\#unexpected-restrict_user_defined_variables-value-in-response "Permalink")
