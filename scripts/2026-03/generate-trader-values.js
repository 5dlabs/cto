 ...
 *
 * Usage:
 *   node scripts/2026-03/generate-trader-values.js              # Dry run (show what would be generated)
 *   node scripts/2026-03/generate-trader-values.js --write       # Actually write files
 *   node scripts/2026-03/generate-trader-values.js --write --update-appset  # Also update ApplicationSet
 */
...
if (WRITE) {
  for (const v of allVariants) {
    ...
    writeFileSync(outFile, `# Auto-generated by scripts/2026-03/generate-trader-values.js\n# Do not edit manually — re-run the generator instead.\n---\n${yaml}`);
