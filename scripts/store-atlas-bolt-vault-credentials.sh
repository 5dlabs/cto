...
echo ""
echo "📋 Next Steps:"
echo "   1. Verify ExternalSecrets are syncing:"
echo "      kubectl get externalsecrets -n secret-store | grep -E 'atlas|bolt'"
echo "      kubectl get externalsecrets -n agent-platform | grep -E 'atlas|bolt'"
echo ""
...
echo "      git add infra/secret-store/agent-secrets-external-secrets.yaml"
