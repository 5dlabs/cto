//! Agent Activity types for Linear's agent system.
//!
//! This module provides types for emitting activities to Linear's agent dialog,
//! including thoughts, actions, responses, errors, and plan steps.
