...
use crate::alerts::events::NotifyEvent;
use crate::alerts::{ChannelError, NotifyChannel};
...
impl SlackChannel {
    ...
    fn format_payload(event: &NotifyEvent) -> SlackPayload {
        let color = match event.severity() {
            crate::alerts::events::Severity::Info => "#3498db", // Blue
            crate::alerts::events::Severity::Warning => "#f39c12", // Orange
            crate::alerts::events::Severity::Critical => "#e74c3c", // Red
        };
