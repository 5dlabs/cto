...
impl CLIType {
    ...
    /// Get all available CLI type variants
    #[must_use]
...
/// Configuration format types (from types module)
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum TypesConfigFormat {
...
pub struct CLIConfiguration {
    ...
    pub config_format: TypesConfigFormat,
...
/// Agent configuration (from types module)
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TypesAgentConfig {
    /// Agent role/name
    pub role: String,
    /// Agent capabilities
...
/// CLI selection criteria for routing
#[derive(Debug, Clone, Default)]
pub struct CLISelectionCriteria {
    /// Preferred CLI type (if any)
