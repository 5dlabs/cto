    ...
    switch (currentStep) {
      ...
      case 3:
        return (
          <div className="space-y-6">
            <p className="text-muted-foreground">
              Connect your GitHub account to allow CTO to create branches and pull requests.
            </p>
            {githubConnected ? (
              <>
        ...
        return (
          <div className="space-y-6">
            <p className="text-muted-foreground">
              ...
              This allows GitHub to send events to your local CTO instance.
            </p>
            {cloudflareConnected ? (
              <>
                <div className="flex items-center gap-3 p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
    ...
    <div className="min-h-screen flex items-center justify-center p-8 bg-gradient-to-br from-background to-muted/20">
      <div className="w-full max-w-2xl space-y-8">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-bold">Welcome to CTO</h1>
          <p className="text-muted-foreground">
