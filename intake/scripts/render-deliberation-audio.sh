...
#
# Usage: render-deliberation-audio.sh <name> <transcript_json> <output_mp3> <status_json> <log_file>
...
mkdir -p "$(dirname "$OUTPUT_MP3")" "$(dirname "$STATUS_JSON")" "$(dirname "$LOG_FILE")"
