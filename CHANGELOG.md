...
## [0.2.81](https://github.com/5dlabs/cto/compare/v0.2.80...v0.2.81) (2026-04-22)


### ✨ Features

* **openclaw-agent:** add DigitalOcean Gradient provider to opencode.json ([#4784](https://github.com/5dlabs/cto/issues/4784)) ([3ff98bc](https://github.com/5dlabs/cto/commit/3ff98bcc91d1bdae0d7118811cc94339054c016c))
...
* **hunyuan-docker:** optimize Dockerfile for CI builds ([de601cb](https://github.com/5dlabs/cto/commit/de601cb4fb4edb0821f8b5418be03d74ba157bcf))
...
* add [@cto](https://github.com/cto) chat participant extension for code-server ([081c772](https://github.com/5dlabs/cto/commit/081c772f52db4ebcc32c43710cf8a5d7160e0b73))
* **avatar-agent:** wire MuseTalk NATS client + LiveKit video publication ([#4706](https://github.com/5dlabs/cto/issues/4706)) ([714d143](https://github.com/5dlabs/cto/commit/714d1438a90fb4d22a6a2baefe51c5446f9ecc6e))
* **avatar:** add GitHub Actions workflow for musetalk-worker image ([dde1a3f](https://github.com/5dlabs/cto/commit/dde1a3f1bf109fe098088f52ba2e729ed263f30f))
* **blaze:** add Storybook MCP per-project component library bootstrap ([9684836](https://github.com/5dlabs/cto/commit/96848361815f26cbfdbbfe0277a706956f96fc77))
* **coder:** auto-open CTO sidebar + show activity bar on launch ([10ccdf7](https://github.com/5dlabs/cto/commit/10ccdf70696164b6094129d3eb8da7674351a036))
* **coder:** match live settings + only 5D in activity bar ([41b446d](https://github.com/5dlabs/cto/commit/41b446d919e09f1b512329028106e9f010c38f1a))
* **controller:** add enableCodeServer support to CodeRun CRD ([575f617](https://github.com/5dlabs/cto/commit/575f617bf71b26f160b49e87c2bbd1311a8aac07))
* **cto-sidebar:** add CTO sidebar extension + deploy to code-server ([07d8a1a](https://github.com/5dlabs/cto/commit/07d8a1ab62d9369029c582f2e08f8092f9e46631))
* **gitlab-mirror:** in-cluster CronJob mirroring GitHub→GitLab via SSH ([4029aad](https://github.com/5dlabs/cto/commit/4029aadc21f7810dad0953a62b020f1d4b7b5803))
* **gitlab-mirror:** inject GH PAT for private cto clone ([c8e69e1](https://github.com/5dlabs/cto/commit/c8e69e1c8335d71561e2e08c5262b08d86e83e3f))
* **hunyuan-avatar:** add parallel HunyuanVideo-Avatar worker ([d9ff150](https://github.com/5dlabs/cto/commit/d9ff1505e5a136e826034d8447e000a2cc705e9d))
* **intake:** add OSS component catalog and surface via design bundle manifest ([356101d](https://github.com/5dlabs/cto/commit/356101dbb8f7381bd7b695f2f35616deffe7ac19))
* **intake:** hard-remove Framer; widen design schemas for OSS providers + Storybook ([25f8b68](https://github.com/5dlabs/cto/commit/25f8b68ce0fd19c289af68e2e5aab8b03b3c4af9))
* **intake:** wide-OSS design funnel + per-project Storybook component library ([f079f22](https://github.com/5dlabs/cto/commit/f079f228a12545bc86b2444b64a0df96909a2027))
* **musetalk-worker:** add BuildKit-optimized Dockerfile ([07ee694](https://github.com/5dlabs/cto/commit/07ee6949b09bbfbeab76cb836bf9f71b6e17f207))
* **musetalk-worker:** add nvidia runtimeClassName for GPU binding ([0665894](https://github.com/5dlabs/cto/commit/066589432370438932e617b73e9c1f3216cc91e0))
* **musetalk:** add debug statefulset application ([81f6a5a](https://github.com/5dlabs/cto/commit/81f6a5a81393a832c04460b896580d881bcf2593))
* **musetalk:** add GitHub Actions workflow to build and push worker image ([76fd722](https://github.com/5dlabs/cto/commit/76fd722535b19953ff61fe4c8412eb3cf34c8040))
* **musetalk:** add test harness and SeaweedFS integration ([557f226](https://github.com/5dlabs/cto/commit/557f226400487d146fae753b6010873ff8bf9a90))
* **musetalk:** wire upstream v1.5 inference into render_avatar ([bf9d906](https://github.com/5dlabs/cto/commit/bf9d9069a7e06bc47cc9c9c86e41624f3f952620))
* **phase4:** GPU provision progress - driver working, toolkit WIP ([7a77259](https://github.com/5dlabs/cto/commit/7a77259e962376020a86d2a4ffc97511521aec0d))
* **phase4:** Update MuseTalk worker nodeSelector for V100S GPU ([4536e79](https://github.com/5dlabs/cto/commit/4536e7960736ac8536239a771e8a6032e06a10ce))
* **sidebar:** wire to OpenClaw gateway OpenAI-compat API ([#4683](https://github.com/5dlabs/cto/issues/4683)) ([829a3cc](https://github.com/5dlabs/cto/commit/829a3cc1bd267d0c08e5d16c1bb1ee266e3f57ff))
* stable tunnel URL for Coder, ephemeral for CRDs ([81de67a](https://github.com/5dlabs/cto/commit/81de67ad7e4aa5128d1172e46ba9aca00bbc77d2))
* upgrade [@cto](https://github.com/cto) extension to v0.2.0 — conversation history + default participant ([eebe969](https://github.com/5dlabs/cto/commit/eebe96972db368e6fbcc55ec14a6a3ab0aecc08d))
* v0.3.0 — dynamic agent discovery + 5dlabs CTO branding ([b180435](https://github.com/5dlabs/cto/commit/b1804357b6a218cf0b89a87aacdc0d790e6775fd))


### 🐛 Bug Fixes

* **acp:** correct Copilot ACP invocation; mandate harness for Coder ([36e1a5f](https://github.com/5dlabs/cto/commit/36e1a5f5e035ff40cb109e16cc622859cf093bc4))
* **acpx:** plumb permissionMode + nonInteractivePermissions into plugin config ([#4707](https://github.com/5dlabs/cto/issues/4707)) ([dd17f11](https://github.com/5dlabs/cto/commit/dd17f115f680cdec2953f34f41c3775c27fdeef3))
* **agents:** patch acpx to pass --allow-all to copilot ACP ([4332fbb](https://github.com/5dlabs/cto/commit/4332fbbc6047e35d7db526973d1808ccdbb5655a))
* **code-server:** remove password requirement ([506ecbc](https://github.com/5dlabs/cto/commit/506ecbc2b373057a2610ecc4e7f87c01e783af87))
* **coder:** add agentDefaults.heartbeat 2m + openai-api fallback ([34235b8](https://github.com/5dlabs/cto/commit/34235b855f5397f2e175362bdfc820af321c7633))
* **coder:** disable quick tunnel for public code-server ([02bd57b](https://github.com/5dlabs/cto/commit/02bd57b3c6b926752031344efe146fda26a96920))
* **coder:** install kaniko docker shim via agent postStart hook ([#4686](https://github.com/5dlabs/cto/issues/4686)) ([7048d99](https://github.com/5dlabs/cto/commit/7048d99254ba117ec7a9a8532a6e2e0377c4a5cc))
* **coder:** move autonomy directive to heartbeat.prompt (actually renders) ([#4710](https://github.com/5dlabs/cto/issues/4710)) ([bfe9ded](https://github.com/5dlabs/cto/commit/bfe9ded486216981f12a04526f3c86d1d81ea325))
* **coder:** move kimi to last-resort fallback ([074b8d8](https://github.com/5dlabs/cto/commit/074b8d85ed46d5c2e99d0f116118e787845b1358))
* **coder:** persist stable code-server URL in boot config ([#4687](https://github.com/5dlabs/cto/issues/4687)) ([ea5450a](https://github.com/5dlabs/cto/commit/ea5450a0a74e60b6e76b91a6028b3c7676b6fd96))
* **coder:** raise kaniko memory budget for large image builds ([#4697](https://github.com/5dlabs/cto/issues/4697)) ([0ec3061](https://github.com/5dlabs/cto/commit/0ec30614ce5d9b36aad98c1c49ef144a7dd270d2))
* **codex:** replace invalid model gpt-5.4-pro with gpt-5.3-codex ([#4708](https://github.com/5dlabs/cto/issues/4708)) ([7671077](https://github.com/5dlabs/cto/commit/76710772cdbb69d7b01a0635d6b0aa873146c215))
* **controller-ci:** add missing shared/ directory to Docker build context ([e7984eb](https://github.com/5dlabs/cto/commit/e7984eba7c4d5653c546bd6f4b34f2392a9c5266))
* **cto-sidebar:** add @types/node for CI tsc build ([a0ebdcb](https://github.com/5dlabs/cto/commit/a0ebdcbf334e251d0f684810084818d465d10646))
* git pull before custom extension install (stale workspace) ([f8a0cdb](https://github.com/5dlabs/cto/commit/f8a0cdb1275d6abfdc85f5434df847e680892cbf))
* **gitlab-ci:** remove RUSTUP_HOME override so rust:latest toolchain is found ([6b1505a](https://github.com/5dlabs/cto/commit/6b1505a1977c549e6d2002c49be970ed23c7bde9))
* **gitlab-mirror:** push from refs/remotes/origin to avoid stale local branch ([989d0ba](https://github.com/5dlabs/cto/commit/989d0ba9aa3a8981b171d546cdc69c0493f256c9))
* **gitlab:** ignore SSA-defaulted fields on gitaly StatefulSet ([7c4027d](https://github.com/5dlabs/cto/commit/7c4027d9ba54ed8650462cfa4de824ce9484ee75))
* **healer-ci:** resolve clippy map_unwrap_or warnings ([58486f5](https://github.com/5dlabs/cto/commit/58486f517c8ae37aef318a4836b212f126c25435)), closes [#4696](https://github.com/5dlabs/cto/issues/4696)
* **healer:** clippy sort_by_key + map_or ([5aefda7](https://github.com/5dlabs/cto/commit/5aefda758157d63e41ab0859fc9bacfb173f9b6a))
* **healer:** resolve clippy duration_suboptimal_units in main.rs ([074eac1](https://github.com/5dlabs/cto/commit/074eac11dc5cf76701737513dcf25915337298b3))
* **healer:** resolve clippy pedantic lints ([c563fff](https://github.com/5dlabs/cto/commit/c563fff5e77a0a9910cb13c3fcd112cff7c289ac))
* **healer:** use Duration::from_mins for clippy duration_suboptimal_units ([a052246](https://github.com/5dlabs/cto/commit/a052246380e1d5fd9470327f400d57615056e03f))
* **hunyuan-test-harness:** use alpine/k8s:1.31.0 ([dec0631](https://github.com/5dlabs/cto/commit/dec063140e37cf7614631b920481e73029c65b45))
* **hunyuan-test-harness:** use bitnami/kubectl:1.31 ([416929d](https://github.com/5dlabs/cto/commit/416929db1c4557c5f0756612e2d88d9d528ec9a6))
* **hunyuan:** scale worker to 0 replicas until GPU node available ([f9b0788](https://github.com/5dlabs/cto/commit/f9b07887726c38c18d78ae401585ee3af9bb82b1))
* **hunyuan:** use generic GPU node selector for worker scheduling ([033cdf1](https://github.com/5dlabs/cto/commit/033cdf122dc7bb2f599438bace6b5b94c559625b))
* **intake:** clippy option_as_ref_cloned ([c256022](https://github.com/5dlabs/cto/commit/c25602294fac434e02a3d06b1aeb4717e8d87055))
* **musetalk-ci:** build Dockerfile.optimized for mmcv install ([1a63104](https://github.com/5dlabs/cto/commit/1a6310471d199b05ada29821aa524774193066f9))
* **musetalk-harness:** add ghcr-secret imagePullSecret ([69ccb10](https://github.com/5dlabs/cto/commit/69ccb1038a5e0857e1ecc2502c6c32111e2da3c8))
* **musetalk-harness:** tolerate pre-existing NATS stream ([f8189a7](https://github.com/5dlabs/cto/commit/f8189a7723c808cf7e6c154dcdee34999cb18a4a))
* **musetalk-harness:** use yongen assets + pullPolicy Always ([c21e5b0](https://github.com/5dlabs/cto/commit/c21e5b06a692e86a0fb786729482d8cb269cd2c4))
* **musetalk-test-harness:** correct inline ArgoCD values key to referenceImageURL ([7c69664](https://github.com/5dlabs/cto/commit/7c69664458b89e73ca46da042ab97fdbef13b7fb))
* **musetalk-test-harness:** handle Phase 4 bootstrap-only validation ([e852112](https://github.com/5dlabs/cto/commit/e8521121b49505a926a1e3894e1c88c343ed8025))
* **musetalk-test-harness:** use real MuseTalk repo assets ([10283c4](https://github.com/5dlabs/cto/commit/10283c41e0f73cd784825fe8083f3df319cd7d88))
* **musetalk-worker:** add diagnostics to fetch loop to debug silent hang ([0972c66](https://github.com/5dlabs/cto/commit/0972c6672ab471dcc77d0b81fc71ffb5f91ccbaf))
* **musetalk-worker:** add symlink init container for musetalkV15 compatibility ([3312951](https://github.com/5dlabs/cto/commit/33129518dded61e86a2b996e810b4838369892b3))
* **musetalk-worker:** chdir to MODEL_CACHE_DIR before model load ([5f91a1e](https://github.com/5dlabs/cto/commit/5f91a1e13e2c36bc43c16a54c41fe2fc9c2c56da))
* **musetalk-worker:** create models/musetalkV15 symlink for chdir compatibility ([c9729ed](https://github.com/5dlabs/cto/commit/c9729edc523855cf81e90b744bfcbc0a895e4d1e))
* **musetalk-worker:** create musetalkV15 symlink for upstream compatibility ([c187581](https://github.com/5dlabs/cto/commit/c18758110e5061475a206bb880ef110b88944a48))
* **musetalk-worker:** disable download init container - models already on PVC ([6b9f706](https://github.com/5dlabs/cto/commit/6b9f7060fd5764c51b1eece5e614ba85a6e35418))
* **musetalk-worker:** fix dpkg statoverride issue and model path resolution ([c16d776](https://github.com/5dlabs/cto/commit/c16d7768989d192eb9d9934d046cb9212ee6153a))
* **musetalk-worker:** more aggressive dpkg fix for container builds ([c3115fd](https://github.com/5dlabs/cto/commit/c3115fd78a034d7d9c4566c140e5efb8243aef75))
* **musetalk-worker:** pin argocd app inline tag override to 60556388 ([a4fb522](https://github.com/5dlabs/cto/commit/a4fb522fa18243f77d7f458457554637e35c9d5e))
* **musetalk-worker:** pin to existing GHCR tag 60556388 ([194baa1](https://github.com/5dlabs/cto/commit/194baa195ac9f9c7920a7959e2f76b46c85fa5c3))
* **musetalk-worker:** pre-install chumpy without build isolation; fix livekit package name; add gnupg/ca-certificates for apt ([d91fea3](https://github.com/5dlabs/cto/commit/d91fea3f4e8321ec010e6d1cfa28783b35bc15ae))
* **musetalk-worker:** support file:// scheme and local paths in download_file ([9ee9ce3](https://github.com/5dlabs/cto/commit/9ee9ce307897e560750d9a8ff0fa8d7bbb01e664))
* **musetalk-worker:** use pull_subscribe for fetch-based NATS consumption ([37b048b](https://github.com/5dlabs/cto/commit/37b048b67dd7af9d7a5c7fe498b1accf21e37384))
* **musetalk-worker:** use working image tag d36038d32 ([b15b968](https://github.com/5dlabs/cto/commit/b15b968302e77678ef19cfe66c110e443250cfe4))
* **musetalk:** add einops dependency for MuseTalk utils ([947a06f](https://github.com/5dlabs/cto/commit/947a06fc9e17b247eb4855254327102468ccde2d))
* **musetalk:** align bootstrap with upstream model artifact layout ([c0a6f69](https://github.com/5dlabs/cto/commit/c0a6f69ba92bbdb5f47383cc377cd6a142a04a3d))
* **musetalk:** align bootstrap with upstream model artifact layout ([289bf37](https://github.com/5dlabs/cto/commit/289bf375c795a455cfec27062cd557ab357bb754))
* **musetalk:** correct NATS URL to openclaw-nats service ([#4692](https://github.com/5dlabs/cto/issues/4692)) ([ea93e6c](https://github.com/5dlabs/cto/commit/ea93e6c013cc4ccd24e3edce419cbef201ef0f04))
* **musetalk:** dedicated NATS with JetStream in cto namespace ([#4693](https://github.com/5dlabs/cto/issues/4693)) ([9225d1b](https://github.com/5dlabs/cto/commit/9225d1b3672784670237b7db458c7e52776899c0))
* **musetalk:** disable argocd-image-updater until CI builds resume ([72e5950](https://github.com/5dlabs/cto/commit/72e59508750af1cc974f67c60b590363ecda2d85))
* **musetalk:** download required HF models (VAE, wav2vec) for MuseTalk ([71ed094](https://github.com/5dlabs/cto/commit/71ed0948c41523208df3a0dd10d3db884c7182e0))
* **musetalk:** enable model download to populate PVC ([0eba594](https://github.com/5dlabs/cto/commit/0eba5943d78abb90be904f5bea8013063bfc8601))
* **musetalk:** force fresh pulls and slim bootstrap image ([8180cf6](https://github.com/5dlabs/cto/commit/8180cf606aa8de573f1c7394b6af4c75a383d991))
* **musetalk:** force fresh pulls and slim bootstrap image ([f1a9b74](https://github.com/5dlabs/cto/commit/f1a9b74b9951721b22bd64d988551f700c888a9d))
* **musetalk:** point ArgoCD app inline values at dedicated NATS ([#4694](https://github.com/5dlabs/cto/issues/4694)) ([f29b036](https://github.com/5dlabs/cto/commit/f29b036753dd8ec36dbde4790af9b4237a25edde))
* **musetalk:** remove GPU product node selector requirement ([d72a3bf](https://github.com/5dlabs/cto/commit/d72a3bf5f30c80f458c2525b9fb2c64fe1f3dc1d))
* **musetalk:** replace mmcv-lite with full mmcv for CUDA ops ([fac49d5](https://github.com/5dlabs/cto/commit/fac49d5e62b87f7213d400b6fc6080f265687348))
* **musetalk:** resolve unresolved merge conflict markers in Dockerfile ([#4690](https://github.com/5dlabs/cto/issues/4690)) ([90125ba](https://github.com/5dlabs/cto/commit/90125ba59f57f3ab6c9629b8eb426b171be898e3))
* **musetalk:** use Ubuntu 22.04 + Python 3.11 + CUDA 11.8 for livekit-rtc compatibility ([83ba4ff](https://github.com/5dlabs/cto/commit/83ba4ffaa321bd7491d449abe62504bd69d0d06f))
* **musetalk:** use ubuntu:22.04 base with manual CUDA install ([79444a2](https://github.com/5dlabs/cto/commit/79444a2caf377e0ec456ccb9c109d0fce4ae7e94))
* **openclaw-agent:** install acpx globally, bump 0.1.16 → 0.5.3 ([d36038d](https://github.com/5dlabs/cto/commit/d36038d322c0b78b01f2cc06026e4be4358b8457))
* **openclaw-agent:** remove OPENAI_API_KEY env clobber ([6a9fd1a](https://github.com/5dlabs/cto/commit/6a9fd1a7a839a59601036658521e22814fe5bffc))
* **pm-ci:** resolve clippy and docker-lint failures ([28d64db](https://github.com/5dlabs/cto/commit/28d64db5c35ae4a0e8a5332e99ed065a91356eca)), closes [#4703](https://github.com/5dlabs/cto/issues/4703)
* **pm-ci:** resolve clippy::map_unwrap_or and duration_suboptimal_units ([239618c](https://github.com/5dlabs/cto/commit/239618ca0a867e75da6ffee32f64df985f0733e8))
* **pm:** resolve pedantic clippy errors to green pm-ci ([01a181c](https://github.com/5dlabs/cto/commit/01a181cadb2225f040e54e35ad90c671fc1b91b6))
* **research-ci:** resolve clippy and docker-lint failures ([6c50452](https://github.com/5dlabs/cto/commit/6c5045264c3f55ca0d8f9c7969ae0189025bc778))
* **research-ci:** resolve clippy duration_suboptimal_units and hadolint install ([cb640d4](https://github.com/5dlabs/cto/commit/cb640d4e57d1b8a954d41784eb10811585648fcc))
* **research:** cargo fmt anthropic.rs ([7985015](https://github.com/5dlabs/cto/commit/79850158fd3b26739a47827c9cb6e121674e4c14))
* **research:** resolve clippy pedantic errors ([0e1b839](https://github.com/5dlabs/cto/commit/0e1b83951bd739d66b762b2fa0e664e51b030bd7))
* switch extension install to pvPath (PV-cached vsix) ([050d2e0](https://github.com/5dlabs/cto/commit/050d2e0f14a1ef08c788f282eca22dfec1eb390f))
* use repo path for cto-chat extension install (private repo) ([2c894cf](https://github.com/5dlabs/cto/commit/2c894cff2e9701fbbc90945692f263f91e836e35))


### ♻️ Refactoring

* **code-server:** extract shared config to shared/code-server-config/ ([#4684](https://github.com/5dlabs/cto/issues/4684)) ([c52c38a](https://github.com/5dlabs/cto/commit/c52c38adeddc27786b98156e58b21d87cdba7e27))
* **musetalk-worker:** rename deployment.yaml to workload.yaml, add service ([fcb5e41](https://github.com/5dlabs/cto/commit/fcb5e4137c3fe294de7b87e9edde413bfd4022b0))


### 📚 Documentation

* **agents:** add parallel agent execution orchestrator pattern ([4bb3f10](https://github.com/5dlabs/cto/commit/4bb3f108cf16b90e30072b438fd7c9cc0ff07d33))
* **coder:** note GHCR quota exhausted, build images locally ([fd68302](https://github.com/5dlabs/cto/commit/fd68302ec6c9ec9a1902c4a4911f2a87b69c6ce4))
* **cto-sidebar:** document activity-bar hiding limitation in code-server 4.116 ([#4682](https://github.com/5dlabs/cto/issues/4682)) ([c640244](https://github.com/5dlabs/cto/commit/c640244af5644863821f38b93fd62a392a1da9ab))
* **intake:** document wide-OSS funnel + per-project Storybook scaffold ([239ffd3](https://github.com/5dlabs/cto/commit/239ffd3cb0a588981bfe5807168fbcd5b5811cb5))
* PRD for self-hosted GitLab cutover + CTO app parity ([ff65174](https://github.com/5dlabs/cto/commit/ff6517426eb3aa4dc4987b21894bac04598eb096))


### 🔧 Maintenance

* **coder:** mount OVH API credentials into agent pod ([75fa01b](https://github.com/5dlabs/cto/commit/75fa01bff89d3b525fa843e17c20c809b51d2571))
* **gitlab:** extend mirror rollout TARGETS with 11 backfill repos ([48b1073](https://github.com/5dlabs/cto/commit/48b1073fd88ff92de2004b5985d83e7bc6f8de29))
* **gitops:** bump musetalk-worker to phase4-9ee9ce307 ([9b706a7](https://github.com/5dlabs/cto/commit/9b706a7c443bc15258e741821b58d9b2e3c94d77))
* **musetalk-worker:** bump image to phase4-bf9d906 (real inference) ([f9f9b8d](https://github.com/5dlabs/cto/commit/f9f9b8de8143415a91c1654df96e6b11fb7f877f))
* release 0.2.65 ([#4678](https://github.com/5dlabs/cto/issues/4678)) ([d627467](https://github.com/5dlabs/cto/commit/d62746706d3c7ba3e9a703ad84286945bd8a5a38))
* **semgrep:** exclude skills/ and bundled third-party package dirs ([7bb2d70](https://github.com/5dlabs/cto/commit/7bb2d70407d2d9b0590a2354a972413744f3dad4))
* trigger GitHub Actions workflow for musetalk-worker image build ([fa0c738](https://github.com/5dlabs/cto/commit/fa0c73882954df5ea326693587ac0ecae9a1e57b))


### 👷 CI/CD

* add GitHub Actions workflow for musetalk-worker image ([71bcbcf](https://github.com/5dlabs/cto/commit/71bcbcf253ea67ba1bf49c74243a8dea831585d9))
* gate mirror-to-gitlab on MIRROR_TO_GITLAB var ([3a3c761](https://github.com/5dlabs/cto/commit/3a3c761432e903e09ab7c370eeb3b048cbef9b0b))
* GitLab mirror rollout tooling ([6d84f85](https://github.com/5dlabs/cto/commit/6d84f85fdea63b46d2230c3532d9109e28a617b8))
* **gitlab-mirror:** dual-publish template + cto POC config ([#4711](https://github.com/5dlabs/cto/issues/4711)) ([276003b](https://github.com/5dlabs/cto/commit/276003bf0ffc969ceb0abcf3ce80ee003c14b839))
* **gitlab:** add 7 parity jobs for full GH image coverage ([513e3cd](https://github.com/5dlabs/cto/commit/513e3cd3d121159ec942d54d2ee306e5b53f74a7))
* **gitlab:** add GitLab-only semantic-release config + cto-sidebar VSIX publishing ([d0f6700](https://github.com/5dlabs/cto/commit/d0f670003a430cc6ae929f5d7974cef7cd5aaccb))
* **gitlab:** align rust lint/test with GitHub per-crate parity ([e8e0bbc](https://github.com/5dlabs/cto/commit/e8e0bbc81a9e17b159e0d31481600091471bbd3c))
* **gitlab:** allow api+schedule pipeline sources to build images ([dd77a28](https://github.com/5dlabs/cto/commit/dd77a28ffc90174be2e56e640f493a339b3f3af3))
* **gitlab:** allow_failure on skills-security-scan for GH parity ([2729809](https://github.com/5dlabs/cto/commit/27298090d3d6cb0c030852a0956cdc07e46ff81f))
* **gitlab:** always run on main + tags; cover semver tag pipelines ([88147db](https://github.com/5dlabs/cto/commit/88147dbaaf9405f729e8f06d37edf7398934c560))
* **gitlab:** auto-retry docker builds on transient gitaly failures ([db437b5](https://github.com/5dlabs/cto/commit/db437b5d4eee6e392c719a6a7706bc35778c7824))
* **gitlab:** bypass Cloudflare tunnel for Docker pushes via in-cluster registry ([06c1b37](https://github.com/5dlabs/cto/commit/06c1b377a173d1bcb7e7f907b41a5cd18a718d12))
* **gitlab:** drop cto-mcp from rust loops; allow new Rust 1.95 pedantic lints ([979c366](https://github.com/5dlabs/cto/commit/979c366adbc96374500f099221a6f643d7afb678))
* **gitlab:** fix rust-clippy duration lint + stale intake test assertion ([ab04831](https://github.com/5dlabs/cto/commit/ab048311b4d6d24c5804da2e8c7f2febb2668a9c))
* **gitlab:** fix semantic-release plugins and make semgrep a real gate ([8cbf1a4](https://github.com/5dlabs/cto/commit/8cbf1a43342b5d5d4d13833aa8346cc3c3d32fbc))
* **gitlab:** fix semantic-release shallow clone + gate non-tag commits ([5e1c46b](https://github.com/5dlabs/cto/commit/5e1c46b0468b0e65425a9800f845cc7cda972908))
* **gitlab:** global shallow clone + retry to mitigate gitaly EOFs ([e122bda](https://github.com/5dlabs/cto/commit/e122bda700806db6ee46105e4dc2a611e4e746e4))
* **gitlab:** guard sccache + apply cargo fmt ([730c22c](https://github.com/5dlabs/cto/commit/730c22cf8246760285b218d14c632526ec373680))
* **gitlab:** install GTK3/webkit2gtk dev libs for workspace rust CI ([275112f](https://github.com/5dlabs/cto/commit/275112f0c1d74a7e426f740094253ea61b3673ed))
* **gitlab:** install jq + python3 in intake-step-tests ([27dbe52](https://github.com/5dlabs/cto/commit/27dbe5211dfa041681600424deafc86e8a80cc7b))
* **gitlab:** mark security scans as advisory (allow_failure) ([7b5e3c5](https://github.com/5dlabs/cto/commit/7b5e3c597979186211a0b1d1801ed0e9cd3e27eb))
* **gitlab:** pass explicit target path to semgrep to avoid /src docker auto-detect ([da57cc0](https://github.com/5dlabs/cto/commit/da57cc08548a8c38381454d7321760f360087146))
* **gitlab:** pin rust to 1.94 and drop cto-mcp from release ([72a13eb](https://github.com/5dlabs/cto/commit/72a13eb5167145120cce751dd446bc43f2df4553))
* **gitlab:** push images under project path for JWT scope ([ea02330](https://github.com/5dlabs/cto/commit/ea023301f92862bf04b1c704fa02496b5c960b47))
* **gitlab:** reduce gitaly load on parallel docker builds ([9c9f22b](https://github.com/5dlabs/cto/commit/9c9f22b165c8f35ab14451ad8f6d25d9f2c7f15b))
* **gitlab:** route Docker Hub pulls through GitLab dependency proxy ([1e8bb47](https://github.com/5dlabs/cto/commit/1e8bb47201b80ba491f43a87fbc22c7bce20ce5f))
* **gitlab:** serialize docker-builds via resource_group ([dc5eaa3](https://github.com/5dlabs/cto/commit/dc5eaa3fdc7514b7ad5eb469bf065e1f413f1180))
* **gitlab:** use local target for Rust+grok Dockerfiles ([0ba5e84](https://github.com/5dlabs/cto/commit/0ba5e84fe12c87edfb178eaecfce96c195766085))
* **mirror:** add workflow_dispatch trigger for manual mirror runs ([cac8fac](https://github.com/5dlabs/cto/commit/cac8fac7f0d16576249d2640b8880c299f2b5326))
* **mirror:** make rollout resilient to per-repo failures ([acd4921](https://github.com/5dlabs/cto/commit/acd49214798e62ef456771c1e263d4c0b6ca7aa8))
* **musetalk-worker:** drop raw phase4-bootstrap tag to unblock GHCR push ([8215f76](https://github.com/5dlabs/cto/commit/8215f76158c1ce90be78df99226a540cdfc16fd9))
* **musetalk-worker:** free disk space before Docker build ([fda2485](https://github.com/5dlabs/cto/commit/fda2485e6a7c22393b729edbc8a4aa20d9faddc0))
* **musetalk:** delete dead workflow and add concurrency guard ([2778b5a](https://github.com/5dlabs/cto/commit/2778b5a2cbb67130559f1aca7777320d83a0da82))
* **musetalk:** use large runner + disk cleanup, drop legacy workflow ([#4685](https://github.com/5dlabs/cto/issues/4685)) ([62becf2](https://github.com/5dlabs/cto/commit/62becf2fb9e237ae0a94ee2ee2e4bff751f79452))
* **security:** allow_failure=true for semgrep-sast (221 baseline findings) ([16a4acc](https://github.com/5dlabs/cto/commit/16a4accc89be88fad6db23e216ba50ad2190a5a3))
