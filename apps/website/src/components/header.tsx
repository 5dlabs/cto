  ...
  return (
    <header className="fixed top-4 left-0 right-0 z-50 flex justify-center px-4">
      <nav className="premium-shell flex items-center gap-1.5 px-2.5 py-1.5 rounded-full backdrop-blur-xl">
        ...
        <Link
          href="/cto/morgan"
          className="hidden sm:flex items-center rounded-full px-3.5 py-1.5 text-xs font-semibold text-white bg-gradient-to-r from-violet-500 via-indigo-500 to-cyan-500 animate-[glowPulse_3s_ease-in-out_infinite] transition-all hover:brightness-110"
        >
          Talk to Morgan
        </Link>
      </nav>
