...
const technicalDepth = [
  {
    ...
    description:
      "Multi-agent orchestration with the OpenClaw platform, MCP server with 60+ tools, NATS-based inter-agent messaging. Model-agnostic: commercial LLM APIs and self-hosted open-weight models with hot-swapping. I build the infrastructure that makes AI agents reliable, observable, and production-grade.",
  },
  {
...
const ventures = [
  { name: "CTO Platform", desc: "Multi-agent AI engineering platform", href: "/cto", status: "Pre-launch" },
  { name: "OpenClaw Platform", desc: "The orchestration layer beneath CTO. Multi-CLI, bare-metal native, and coming soon as open source.", href: "/#openclaw", status: "Coming Soon" },
  {
    name: "Trading Engine",
    desc: "In-house capital and market-intelligence engine across Solana, Base, Polygon, Near, and Sui",
    href: "/trading",
    status: "Active",
  },
];
