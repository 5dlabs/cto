...
const expertise = [
  {
    ...
    description:
      "OpenClaw platform deployment and configuration, agent orchestration, MCP server integration, Claude Code workflows, autonomous development pipelines, custom skill development.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Solana program development, on-chain trading agents, DeFi protocol integration, Base/Polygon/Near/Sui/Ethereum node operations, RPC infrastructure at scale.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
