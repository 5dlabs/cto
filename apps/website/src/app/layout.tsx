...
export const metadata: Metadata = {
  ...
  description:
    "5D Labs is an AI-native venture studio powered by CTO, our build engine, an internal trading engine, and the OpenClaw platform, our orchestration layer. We use this stack to discover, finance, and ship new ventures.",
  keywords: [
    "5D Labs",
    "OpenClaw platform",
    "AI venture studio",
  ...
  openGraph: {
    title: "5D Labs | AI-Native Venture Studio",
    description:
      "AI-native venture studio powered by CTO, an internal trading engine, and the OpenClaw platform.",
    url: "https://5dlabs.ai",
    siteName: "5D Labs",
    locale: "en_US",
    type: "website",
  ...
  other: {
    "ai:description":
      "5D Labs is an AI-native venture studio powered by CTO, our commercial build engine, an in-house trading engine, and the OpenClaw platform, the orchestration layer beneath both. The stack exists to discover, finance, and ship new ventures.",
    "ai:capabilities":
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "5D Labs is an AI-native venture studio powered by an internal operating stack. CTO is the commercial build engine, the internal trading engine helps finance experimentation and provide market intelligence, and the OpenClaw platform is the orchestration layer beneath both. The purpose of the stack is to help 5D Labs discover, validate, and launch new ventures.",
          },
        },
        {
          "@type": "Question",
          name: "What is the OpenClaw platform?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "The OpenClaw platform is 5D Labs' orchestration layer, built on the open-source OpenClaw project. It coordinates AI agents across multiple CLIs (Claude Code, Cursor, Codex, Factory, Gemini), self-healing bare metal Kubernetes infrastructure, and MCP server ecosystems. It powers all 5D Labs ventures and will be open-sourced.",
          },
        },
        {
          "@type": "Question",
