  ...
  return (
    ...
    >
      <nav className="flex items-center gap-1 px-2 py-1.5 rounded-full border border-white/[0.06] bg-white/[0.03] backdrop-blur-xl shadow-[0_0_30px_rgba(0,0,0,0.3)]">
        ...
        <Link
          href="/morgan"
          className="hidden sm:flex shrink-0 items-center justify-center h-8 px-4 rounded-full bg-gradient-to-r from-cyan-500/90 to-blue-500/90 text-white text-xs font-semibold hover:from-cyan-500 hover:to-blue-500 transition-all shadow-[0_0_12px_rgba(34,211,238,0.25)]"
