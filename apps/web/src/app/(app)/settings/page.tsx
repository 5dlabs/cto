...
export default function SettingsPage() {
  ...
  return (
    <div className="flex h-full flex-col overflow-auto">
      ...
      <div className="max-w-3xl flex-1 space-y-8 p-8">
        {/* API Keys */}
        <section>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="bg-muted flex h-10 w-10 items-center justify-center rounded-lg">
                        <span className="text-sm font-medium">{key.name.charAt(0)}</span>
                      </div>
                      <div>
                        <p className="font-medium">{key.name}</p>
                        {key.configured ? (
                          <p className="text-muted-foreground text-xs">Configured {key.lastFour}</p>
                        ) : (
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid gap-2">
                ...
                <p className="text-muted-foreground text-xs">Your tenant namespace: tenant-acme</p>
              </div>
