# Pitch deck — recording-only walkthrough

Screen-record [https://pitch.5dlabs.ai](https://pitch.5dlabs.ai) (or `npm run dev` on port 3010). **~10–15 minutes** if you keep each slide tight.

**Capture:** 1080p+, fullscreen or clean window, arrow keys to advance. One take is fine; you can edit pauses later.

---

| # | What’s on screen | Say (paraphrase is fine) |
|---|------------------|---------------------------|
...
| **02 Problem** | Impact layout, bullets | Four beats in subhead: bill, org, scarce, CTO on metal. Bullets: invoice vs bait; people + sprawl (bill doesn’t shrink with hires alone); model mix; runway pattern (late pivot, low cash). “Decide → ship → learn” stays on **How it works**, not Problem. |
...
**Short version (~6 min):** record slides **01, 02, 06, 07, 10, 13, 16, 17** only (same script, skip the rest).
