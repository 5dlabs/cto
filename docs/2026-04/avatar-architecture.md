...
> **Related**: [`agent-avatar-prompts.md`](../2026-03/agent-avatar-prompts.md), [`morgan-avatar-openclaw-handoff.md`](../2026-03/morgan-avatar-openclaw-handoff.md), [`../avatar-report.md`](../../avatar-report.md) (open-source candidate research), [`../.firecrawl/building-plugins.md`](../.firecrawl/building-plugins.md) (OpenClaw plugin authoring scraped docs).
>
