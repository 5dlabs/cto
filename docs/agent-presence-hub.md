...
- [`docs/morgan-avatar-openclaw-handoff.md`](./morgan-avatar-openclaw-handoff.md) — `AvatarProvider` interface, queue-latency lessons, adapter boundary
- [`docs/acp-nats-research.md`](./acp-nats-research.md) — ACPX/ACP architecture, NATS approach, Approach A verdict
